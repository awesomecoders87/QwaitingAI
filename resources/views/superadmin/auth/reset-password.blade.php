...
<head>
    ...
    <title>Reset Password - SuperAdmin - {{ config('app.name', 'Laravel') }}</title>
        ...
        <div class="w-full max-w-6xl flex rounded-2xl overflow-hidden shadow-2xl">
            ...
            <div class="w-full lg:w-1/2 bg-indigo-900 flex flex-col justify-center px-8 sm:px-12 py-12 lg:py-16">
                <div class="w-full max-w-md mx-auto">
                    ...
                    <p class="text-sm text-gray-300 mb-8">Enter your new password</p>

                    <form method="POST" action="{{ route('superadmin.password.reset.update') }}">
                        @csrf
                        ...
                        <div class="mb-6">
                            ...
                            <input id="email" class="block w-full px-4 py-3 rounded-md border-0 bg-gray-200 text-gray-600 cursor-not-allowed text-sm sm:text-base" type="email" name="email" value="{{ $email }}" required readonly />
                            @error('email')
                        ...
                        <!-- Password -->
                        <div class="mb-6">
                            <label for="password" class="block font-medium text-sm text-white mb-2">New Password</label>
                            <div class="relative">
                                <input id="password" class="block w-full px-4 py-3 pr-12 rounded-md border-0 bg-white text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-indigo-500 focus:outline-none text-sm sm:text-base" type="password" name="password" required autocomplete="new-password" placeholder="Enter your new password" />
                        ...
                        <!-- Confirm Password -->
                        <div class="mb-6">
                            <label for="password_confirmation" class="block font-medium text-sm text-white mb-2">Confirm Password</label>
                            <div class="relative">
                                <input id="password_confirmation" class="block w-full px-4 py-3 pr-12 rounded-md border-0 bg-white text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-indigo-500 focus:outline-none text-sm sm:text-base" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm your new password" />
                                <button type="button" id="togglePasswordConfirmation" class="absolute inset-y-0 right-0 flex items-center pr-4 text-gray-500 hover:text-gray-700 focus:outline-none transition-colors" aria-label="Toggle password visibility">
                                    <!-- Eye icon (visible) -->
                                    <svg id="eyeIconConfirmation" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                    </svg>
                                    <!-- Eye slash icon (hidden) -->
                                    <svg id="eyeSlashIconConfirmation" class="h-5 w-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.29 3.29m0 0A9.97 9.97 0 015.12 5.12m3.17 3.17L12 12m0 0l3.29 3.29M12 12l3.29-3.29m0 0a9.97 9.97 0 012.12-2.12m-3.17 3.17L12 12"></path>
                                    </svg>
                                </button>
                            </div>
