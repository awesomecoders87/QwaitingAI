...
<body class="font-sans text-gray-900 antialiased">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
        ...
        <div class="mb-6">
            <a href="/">
                <img src="/images/logo/superadmin/qwaiting-logo.svg" alt="Qwaiting Logo" class="h-16 w-auto">
            </a>
        </div>
        
        <!-- Title -->
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-800">SuperAdmin Panel</h1>
            <p class="text-sm text-gray-600 text-center mt-2">Sign in to manage your platform</p>
        </div>
