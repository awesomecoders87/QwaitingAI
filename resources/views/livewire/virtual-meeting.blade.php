<style>
    #video-container .virtual-video video {
    min-width: 100%;
    min-height: 100%;
    object-fit: cover;
  }
</style>
<div class="bg-white shadow rounded  h-[100vh]">

        <!-- <h2 class="text-2xl font-bold mb-4 text-gray-800">Meeting</h2> -->

    <!-- Video Grid -->
    <div id="video-container" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 w-full h-[100vh]">
    ...
    <script>
        ...
        function handleParticipant(participant) {
            ...
            div.className = "bg-black rounded relative overflow-hidden h-[100vh] virtual-video";
