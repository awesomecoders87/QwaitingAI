...
class TicketGeneratorComponent extends Component
{
    ...
    public function mount()
    {
        ...
        $this->type = AccountSetting::TICKET_SLOT;
    ...
    public function loadBusinessHours()
    {
       ...
       $customSlots = CustomSlot::with(['team', 'location'])
    ...
    public function removeCustomSlot($dayIndex)
    {
...
if (empty($slot['selected_date'])) {
    ...
    {
        return view('livewire.ticket-generator-component');
    }
}
