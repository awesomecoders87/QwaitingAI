...
class SingleDisplayScreen extends Component
{
    ...
    public $locationStep =false;
    public $displayStep =true;
    ...
    public function mount($location_id = null)
    {
        ...
        if (empty($this->location) &&  Session::has('selectedLocation') == null) {
            $this->allLocations = Location::where('team_id', $this->teamId)->where('status',1)->get();
    ...
    public function render()
    {
        ...
        return view('livewire.single-display-screen');
    }
